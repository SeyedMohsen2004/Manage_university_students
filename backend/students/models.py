...
class User(AbstractUser):
    ...
    profile_image = models.ImageField(
        upload_to=profile_image_upload_to, blank=True, null=True
    )
...
class FoodReservation(models.Model):
    ...
    food = models.ForeignKey(
        "admin_panel.Food", on_delete=models.CASCADE, related_name="reservations"
    )
...
class CourseReservation(models.Model):
    student = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        related_name="course_reservations",
    )
    course = models.ForeignKey(
        "admin_panel.Course", on_delete=models.CASCADE, related_name="reservations"
    )
